...
//    SiteProb site(sp, mutation_prob, evo_model);
    ...
    ASSERT_DOUBLE_EQ(expected_same, summary_stat_same);
...
////    expected_diff /= expected_prob;
//    ASSERT_DOUBLE_EQ(expected_diff, summary_stat_diff*prob_reads_d_given_a, 1e-20);
//    expected_diff = 0.2*0.25;
//    expected_diff /= expected_prob;
//    ASSERT_DOUBLE_EQ(expected_diff, summary_stat_diff, 1e-20);
...
TEST_F(SiteProbTest, TestCalculateAllDescendantGivenAncestor) {
    ...
    ASSERT_DOUBLE_EQ(expected_same, summary_stat_same_ancestor);
...
//    ASSERT_DOUBLE_EQ(expected_prob, sum_prob_ancestor);
    ...
    ASSERT_DOUBLE_EQ(1, overall_stat_diff+overall_stat_same);
...
//    ASSERT_DOUBLE_EQ(expected_prob, sum_prob_ancestor);
    ...
    ASSERT_DOUBLE_EQ(1*sp.GetDescendantCount(), overall_stat_diff+overall_stat_same);
//
}