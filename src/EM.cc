...
//
//void stevenTest(){
//	DirichletMultinomialDistribution dmd = DirichletMultinomialDistribution();;
//	double alphas[4] = {0.1,0.1,0.1,0.4};
//	ReadData data = ReadData({ 0,0,0,0 });
//
//	dmd.DirichletMultinomialRandom(alphas, data);
//}
